...
I set out to understand how to scrape data using Python. I explored `beautifulsoup`, 
`requests`, `scrapingBee` API, and `scrapy` to scrape data from  Google news and 
a product listing page. I wrote a [piece](http://bokola.github.io/posts/2025-08-03-Web-scraping-python/) about it too.
